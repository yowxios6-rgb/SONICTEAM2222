      ...
      <div className="overflow-x-auto">
        {loading ? (
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="text-left text-sonic-blue border-b border-sonic-blue/20">
            ...
            <tbody>
              {promoCodes.map((code) => (
                <motion.tr 
                  key={code.id} 
                  className="border-b border-sonic-blue/10 hover:bg-sonic-blue/5 transition-all"
                  whileHover={{ backgroundColor: "rgba(0, 150, 255, 0.05)" }}
                >
                  <td className="px-4 py-3 font-mono font-medium text-white">{code.code}</td>
                  <td className="px-4 py-3 text-sonic-blue font-semibold">{code.amount}</td>
                  ...
                  <td className="px-4 py-3 text-gray-300">
                    {code.expires_at ? (
                      <div className="flex items-center">
                        <Calendar className="h-4 w-4 mr-1 text-sonic-blue" />
                  ...
                  <td className="px-4 py-3">
                    <div className="flex space-x-2">
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        className="h-8 w-8 p-0 border-sonic-blue/30 glow-border"
                      >
                        {code.is_active ? (
                      ...
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        className="h-8 w-8 p-0 border-red-500/30 hover:bg-red-500/10 glow-border"
                      >
