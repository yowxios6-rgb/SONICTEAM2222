          ...
          >
                ...
                <>
                  ...
                  {user.isOwner && (
                    <motion.button 
                      ...
                      className="flex items-center p-3 rounded-md hover:bg-sonic-gray transition-all duration-200 border border-yellow-400/50 hover:border-yellow-400 group backdrop-blur-sm glow-border"
                      variants={buttonVariants}
                      custom={5}
                      initial="initial"
                      animate="animate"
                    ...
                    >
                      ...
                      <span className="text-yellow-400 group-hover:text-white transition-all duration-200">Owner Panel</span>
                    </motion.button>
                  )}
                </>
              )}
            ...
            <div className="mt-auto space-y-4">
              <motion.button
                ...
                className="w-full p-3 rounded-md bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-medium flex justify-center items-center gap-3 transition-all backdrop-blur-sm glow-border shadow-lg"
                variants={buttonVariants}
                custom={user ? 5 : 2}
                initial="initial"
                animate="animate"
              ...
              <motion.button
                ...
                className="w-full p-3 rounded-md bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white font-medium flex justify-center items-center gap-3 transition-all backdrop-blur-sm glow-border shadow-lg"
                variants={buttonVariants}
                custom={user ? 6 : 3}
                initial="initial"
                animate="animate"
              ...
              <motion.button
                ...
                className="w-full p-3 rounded-md bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-medium flex justify-center items-center gap-3 transition-all backdrop-blur-sm glow-border shadow-lg"
                variants={buttonVariants}
                custom={user ? 7 : 4}
                initial="initial"
                animate="animate"
              ...
              <motion.button
                onClick={() => openExternalLink('https://t.me/yowxios')}
                className="w-full p-3 rounded-md bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-medium flex justify-center items-center gap-3 transition-all backdrop-blur-sm glow-border shadow-lg"
                variants={buttonVariants}
                custom={user ? 8 : 5}
                initial="initial"
                animate="animate"
