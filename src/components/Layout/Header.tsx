...
import { Menu, User, Users, ChevronDown, LogOut, Settings, Shield, Crown } from 'lucide-react';
            ...
            <DropdownMenuContent className="bg-sonic-dark border border-sonic-blue/30 text-white min-w-[180px] animate-fade-in">
              ...
              {user.isOwner && (
                <>
                  <DropdownMenuSeparator className="bg-sonic-blue/20" />
                  <DropdownMenuItem 
                    className="hover:bg-yellow-400/20 focus:bg-yellow-400/20 active:scale-98 transition-all cursor-pointer"
                    onClick={() => navigate('/admin')}
                  >
